...
<?php
	...
	echo "<div align = 'center' valign = 'middle' style = 'width: 280px; height: 21px; background-color: white; border-radius: 3px; margin-top: 9px; padding-top:1px'><font face = 'Calibri' size = '3' color = '#333333'>In Sync With</font></div></td>";
