...
<div id="signup_login_options" align = "left" style = "width: 380px; height: 85px; background-color: #FFFFFF; border: solid 1px #FFFFFF; border-radius: 5px; box-shadow: 0px 0px 4px 0px #86B404; padding-top: 2px; display:block;">

<button style = 'width: 150px; height: 42px; background-color: white; border: solid 1px #ccc; border-radius: 4px; margin-top: 8px; margin-left: 35px; margin-right: 5px;'>
...
<div id="username_password_input" align = "left" style = "width: 380px; height: 85px; background-color: #FFFFFF; border: solid 1px #FFFFFF; border-radius: 5px; box-shadow: 0px 0px 4px 0px #86B404; padding-top: 2px; display:none;">
