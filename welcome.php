...
<?php
	...
	echo "<td style = 'padding-left: 12px'><font face = 'Calibri' size = '5'><b>";
	echo $_SESSION['username'];
	echo "</b></font></td><td style = 'border-left:solid 1px #E6E6E6; padding-left: 10px; width: 30px'><button style = 'width: 60px; height: 25px; background-color: white; border: solid 1px #ccc; border-radius: 4px; type='submit' value='LogOut'><font face = 'Calibri' size = '2'> Log Out </font></button></td></table>";
?>
</div>